		...
		<div class="container">
			...
			<div class="st-hotel-room-content <?= esc_html( $class ) ?>">
					...
					if ( $room_external == 'off' || empty( $room_external ) ) {
						...
						?>
							<a href="<?php echo esc_url( $room_external_link ); ?>"
								class="btn-v2 btn btn-green"><?php echo esc_html__( 'Book Now', 'traveler' ) ?></a>
							<?php
					}
					?>
				</div>
				...
				<div class="row">
					...
					if ($display_icon): ?>
						<span class="amenity d-flex align-items-center">
							<i class="stt-icon fa fa-paw"></i>							<!-- FontAwesome paw icon for 'Pet Friendly' -->
						</span>
						Pet Friendly
				...
				<?php endif; ?>
							...
							<div class="item">
							<span class="stt-icon fa fa-chart-area"></span>
							<?php
							echo __( 'Dimensions: ', 'traveler' );
							
							$terms = get_the_terms( get_the_ID(), 'site-dimensions' );
						...
						<?php echo stt_elementorv2()->loadView( 'services/common/single/description', [ 'title' => esc_html__( 'About This Campsite', 'traveler' ) ] ) ?>
